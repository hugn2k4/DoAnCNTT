  ...
  <div class="container">
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/productManager/update"
        ...
        <div class="mb-3">
          <label for="product-screenSize" class="form-label">Kích thước màn hình <span class="text-danger">*</span></label>
          <input type="number"
        ...
        <div class="mb-3">
          <label for="product-battery" class="form-label">Dung lượng pin <span class="text-danger">*</span></label>
          <input type="text"
        ...
        <div class="mb-3">
          <label for="product-weight" class="form-label">Trọng lượng <span class="text-danger">*</span></label>
          <input type="number"
